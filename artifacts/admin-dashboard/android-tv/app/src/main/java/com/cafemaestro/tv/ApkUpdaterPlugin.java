 ...
 * here. Used exclusively by the in-app "Update Available" flow on Android TV
 * (see src/native/apkUpdater.ts, src/hooks/useApkDownload.ts).
 *
 * Identical logic to the mobile ApkUpdaterPlugin; package name differs
 * to match the TV applicationId (com.cafemaestro.tv).
 */
...
public class ApkUpdaterPlugin extends Plugin {
    ...
    public void download(PluginCall call) {
        ...
        String fileName = call.getString("fileName", "cafe-maestro-tv-update.apk");
