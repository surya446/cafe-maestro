...
function SkeletonCard() {
  return (
    <div className="rounded-2xl overflow-hidden" style={{ background: C.card, border: `1px solid ${C.border}` }}>
      <div className="aspect-square w-full" style={{ background: C.cardHover, animation: "pulse 2s cubic-bezier(.4,0,.6,1) infinite" }} />
...
function QRMenuItemCard({
  ...
  return (
    ...
    >
      {/* Food image — 1:1 square on every screen size; never distorts regardless of card width */}
      {item.image_url ? (
